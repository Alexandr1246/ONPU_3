...
public class PartTimeWorker extends Worker{
    ...
    public void setPay(double pay) {
        this.pay = pay > Constants.MIN_SALARY /(Constants.MONTH_WORK_DAY*Constants.HOURS_PER_DAY) ? pay : Constants.MIN_SALARY /(Constants.MONTH_WORK_DAY*Constants.HOURS_PER_DAY);
    }
    ...
    public String toString() {
        return "PartTime "+ "Worker{" + "id=" + id + ", pay=" +String.format("%10.2f",GetSalary()) + ", name='" + name + '\'' + '}';
    }
